...
import Logo from "./Images/BElogo.png"; // Import your logo image
import waterMark from "./Images/BE-WATERMARK.png"; // Import your logo image
...
const HMSInvoice = () => {
  ...
  const generatePDF = (count) => {
    ...
    pdf.text("BRIGHT ELECTRICIAN", 44, 20);
    pdf.setFont(undefined, "none");
    pdf.setTextColor(0, 0, 0);
    pdf.setFontSize(14);

    pdf.setFontSize(11);
    pdf.text(45, 26, "No. 170,6th cross,Balaji Nagar, Bangalore - 560029");
    // pdf.text(
    //   13,
    //   34,
    //   "E-Mail :brightelectricain@gmail.com             Web : www.brightelectrician.in"
    // );
    pdf.setFontSize(15);
    pdf.setFont(undefined, "bold");

    pdf.text(13, 38, "Invoice");
    ...
    pdf.text(158, 30, "Tanveer ");
    pdf.text(158, 36, "8867266426");
    pdf.setFontSize(10);
    //input
    pdf.rect(12, 41, 95, 7);
    ...
    pdf.text(`BILL NO: BE${randomnum}`, 108, 52.5, { align: "left" });
    ...
    pdf.text(`For Bright Electrician`, 136, 244);
  ...
  return (
    <div className="form-container">
      ...
      <h4>Bright Electrician Invoice</h4>
